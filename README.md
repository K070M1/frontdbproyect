Es es un proyecto hecho en [Next.js](https://nextjs.org) que fue creado con el comando [`create-next-app`](https://nextjs.org/docs/app/api-reference/cli/create-next-app).
